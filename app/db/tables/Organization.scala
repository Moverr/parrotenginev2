...
case class Organization(id:Long = 0L, name:String, details:String,owner:Long, date_created:Timestamp,author_id:Long=null, date_updated:Timestamp,updated_by:Long =null)
