...
//Guest
//,user_id:Option[Long]
case class GuestProfileRequest(surname:String,othername:String,profiletype: ProfileType,gender:String,registerDate:Long,location: PhysicalAddress) extends  ProfileRequest
